let mufar = async (m, { conn }) => {
  ...
  conn.sendMessage(m.chat, { text: `*[ FRACTION LIST ]*\n\n ${tagList}\n\n*Total fitur:${totalfi} Commands*`, contextInfo: { externalAdReply: { title: wm, body: bottime, mediaType: 1, thumbnailUrl: 'https://telegra.ph/file/5c3c1bbf0ed0d4b969ec3.jpg', sourceUrl: 'https://chat.whatsapp.com/Em4vPwiN7151mO3lDpkdrm', renderLargerThumbnail: true } } }, { quoted: m, ephemeralExpiration: global.ephemeral })
}
